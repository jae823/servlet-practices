...
<!-- OS에서 Context의 의미 : Process(의 정보/명령어들의 모임), OS는 프로세스를 실행시키는 역할-->
<!-- Spring에서 Context의 의미 : Application : TOMCAT에서 관리하는 단위, Tomcat은 Application을 실행시키는 역할 -->
</head>
<body>
	<div id="container">
		<div id="header">
		...
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img id="profile" src="<%=request.getContextPath()%>/assets/images/moo.jpg">
					<h2>안녕하세요. 김민재의  mysite에 오신 것을 환영합니다.</h2>
					<p>
						이 사이트는  웹 프로그램밍 실습과제 예제 사이트입니다.<br>
						메뉴는  사이트 소개, 방명록, 게시판이 있구요. 데이터베이스 수업 + 웹프로그래밍 수업 배운 거 있는거 없는 거 다 합쳐서
		...
		<div id="navigation">
			<ul>
				<li><a href="<%=request.getContextPath()%>">김민재</a></li>
